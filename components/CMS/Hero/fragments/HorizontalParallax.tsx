...
// Components
import HeroViewOne from "@/components/CMS/Hero/fragments/HeroViewOne/HeroViewOne";
import HeroViewTwo from "@/components/CMS/Hero/fragments/HeroViewTwo/HeroViewTwo";
import HeroViewThree from "@/components/CMS/Hero/fragments/HeroViewThree/HeroViewThree";
...
const HorizontalParallax: FC<IHero.IHorizontalParallax> = ({
	...
	return (
		<div ref={containerRef} className={styles.horizontalParallax}>
			<m.div ref={sliderRef} className={styles.wrapper}>
				<HeroViewOne
